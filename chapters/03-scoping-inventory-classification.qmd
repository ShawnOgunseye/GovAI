...
Each factor needs a threshold, or the assessment is four opinions. Consequence is severe where a person loses an opportunity they cannot regain, suffers physical or psychological harm, or has a legal or similarly significant effect imposed on them; the EU AI Act's serious-incident definition is a usable floor, covering death or serious harm to health, serious disruption of critical infrastructure, infringement of fundamental rights obligations, and serious harm to property or the environment. Autonomy is high where no human sees the output before it takes effect, and it is also high where a human nominally reviews but the review has never been measured; an unmeasured review is an assumption, not a control, and Calloway's one alteration in four hundred is what measuring it looks like.

Measuring it requires that something be written down at the moment of review, and that is where most deployments fail rather than at the review itself. Three things make a human check measurable. A threshold, so there is a stated point above which the reviewer is expected to act, rather than a score each person interprets privately. A record of the decision, including the cases where the reviewer looked and did nothing, since a process that records only escalations cannot distinguish careful review from no review. And a disagreement rate, which is the single number that says whether the reviewer is deciding or confirming. Where a deployment produces none of the three, the honest entry for this factor is not low but unmeasured, and unmeasured supports the high tier, because the organization cannot show the control exists. Population is high where the affected people cannot detect that the system ran, cannot contest the outcome, or belong to a group the organization has no route to consult. Reversibility, following Canada's scale, runs from effects that are reversible and brief, through likely reversible and short-term, to difficult to reverse and ongoing, to irreversible and perpetual; the last two support a high tier on their own.
...
Read that as a statement about your own tier, not about the law's category. It says a law that binds you sets a floor on the attention you owe, whatever your four factors conclude. It does not say the law's own classification is beyond argument. The AI Act's own Article 6(3) lets a provider conclude that an Annex III system is not high-risk after all, where the system performs a narrow procedural task, improves work a human already completed, detects patterns without replacing human assessment, or does preparatory work, and where it does not profile people. That determination is the provider's to make, to document, and to register. The two rules do not conflict because they answer different questions. Whether the law classifies your system is decided by the law's own test, under section 3.8. What your organization does about a system the law does classify is decided here, and the answer is that you do not argue yourself below the floor.
...
Four rules apply to every tier rather than to any one of them, and they exist because a tier is an assertion about a system that was true when somebody made it. Record an evidence confidence alongside the tier, because an initial classification is only as good as what was known at the time. Treat a low-confidence classification as provisional until an independent reviewer, someone other than whoever proposed it, has confirmed it. Give both the system owner and an affected party a route to appeal the classification itself, not only the decision the system produces. That route has a limit worth stating plainly, because a reader on the receiving end of a system will find it immediately. It runs to someone inside the organization, so it is available only once the organization has classified the system at all. Where nothing was ever classified, there is no tier to appeal and nobody holding the decision, and the person affected has no route here. That is a real gap and not one this chapter closes. What remains to such a person is outside the organization: a regulator where one has jurisdiction, a data protection authority where personal data is involved, or the institution's own complaint process, none of which this chapter governs. An organization reading this should notice that the gap is its own doing. The appeal route exists only where the governance did. And revalidate on a fixed schedule as well as on trigger, because a classification never checked again is a claim about the system's current state made once and never tested.
